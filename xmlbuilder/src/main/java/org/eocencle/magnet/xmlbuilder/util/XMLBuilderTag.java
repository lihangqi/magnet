package org.eocencle.magnet.xmlbuilder.util;
...
public class XMLBuilderTag {
    ...
    public static final String XML_EL_SPLITFIELDTOROWS          = "splitFieldToRows";
    ...
    public static final String XML_ATTR_ISREGEX         = "isRegex";
    public static final String XML_ATTR_ROWNUMFIELD     = "rowNumField";
    public static final String XML_ATTR_CNTFIELD        = "cntField";
    public static final String XML_ATTR_IGNORECASE      = "ignoreCase";
